...
public class UserEntity {
    ...
    @Max(value = 80, message = "Максимальный возраст 80")
    private Integer age;
    ...
    @NotNull
    @Min(value = 1, message = "Часы работы не должны быть меньше 1 часа")
    @Max(value = 24, message = "Часы работы не должны превышать 24 часов")

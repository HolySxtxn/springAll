...
public class DataWorkApplication {
    ...
    CommandLineRunner run(UserService userService) {
        return args -> {
            ...
            userService.addCountry(new Country(null, "Ставрополь"));
            userService.addCountry(new Country(null, "Тихорецк"));
            userService.addCountry(new Country(null, "Видное"));

            userService.addWorkBook(new WorkBook(null, "1234567"));
            userService.addWorkBook(new WorkBook(null, "1234566"));
            userService.addWorkBook(new WorkBook(null, "1111111"));
            userService.addWorkBook(new WorkBook(null, "1111112"));
        };
    }
